<template>
    <span class="w-6 h-8 inline-flex items-center justify-center mr-2">
...
<script setup>
import { isAudio, isExcel, isImage, isPDF, isText, isVideo, isWord, isZip } from '@/Helper/file-helper';
